<aside class="navbar navbar-vertical navbar-expand-sm position-absolute"
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse ms-2" id="navbar-menu">
            <ul class="navbar-nav pt-lg-3">
                @can('dashboard-access')
                    <div class="hr-text hr-text-left ms-2 mb-2 mt-2">Dashboard</div>
                    <li class="nav-item">
                ...
                <div class="hr-text hr-text-left ms-2 mb-2 mt-2">Master Data</div>
                @endcanany
                ...
                @canany(['transactions-access', 'orders-access'])
                    <div class="hr-text hr-text-left ms-2 mb-2 mt-2">Transaksi</div>
                @endcanany
                ...
                @canany(['permissions-access', 'roles-access', 'users-access'])
                    <div class="hr-text hr-text-left ms-2 mb-2 mt-2">Management User</div>
                @endcanany
